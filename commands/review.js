...
module.exports = {
    async execute(interaction, client){
        ...
        if(client.database.awaitingServers.findIndex(isGuildId)==-1) return interaction.editReply({ content: "Ce serveur n'est pas présent dans ma liste de serveurs à vérifier !", ephemeral: true });
